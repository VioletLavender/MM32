...
*                      the "startup_MM32F031x4x6_q.s" file.
*
...
*    Then SystemInit() function is called, in "startup_MM32F031x4x6_q.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "VV_MM32F031x4x6_q.h" file.
