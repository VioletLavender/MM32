...
#define TempSensor_ENABLE                           ((uint32_t)CHEN14_ENABLE)
#define Vrefint_ENABLE                              ((uint32_t)CHEN15_ENABLE)
...
void ADC_RegularChannelConfig(ADC_TypeDef* ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime)
{
    ...
    break;
    case ADC_Channel_TempSensor: ADCx->ADCHS |= TempSensor_ENABLE; //Temperature Sensor
    break;
    case ADC_Channel_Vrefint: ADCx->ADCHS |= Vrefint_ENABLE; //Voltage Sensor 
    break;
